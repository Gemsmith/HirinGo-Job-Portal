    ...
    <div>
      <footer className="text-center text-white  bg-gray-200">
        <div className="px-4 py-6 mx-auto overflow-hidden sm:px-6 lg:px-8">
          <nav className="flex flex-wrap justify-center m-0">
            <div className="px-5 py-2">
              <a
                href="#"
                className="text-base leading-6 text-gray-900 hover:text-gray-900 hover:underline"
              >
                About
              </a>
            </div>
        ...
        <div className="text-center text-white bg-gray-900 px-6 py-3 flex justify-between">
          <span>© 2022 Copyright </span>
          <a className="text-neutral-400" href="https://tailwind-elements.com/">
            Indeed Co.
          </a>
        </div>
      </footer>
