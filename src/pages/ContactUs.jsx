...
const ContactUs = () => {
  return (
    <div className=" text-gray-100 px-4 md:px-8 py-12 ">
      ...
      <div className="mt-12 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-blue-200 text-gray-900 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
              Have a query?
              <br />
              <span className="text-blue-600">Contact Us 24/7</span>
            </h2>

            <div className="text-gray-700 my-9">
              Don't like forms? No worries. Send us an{' '}
              <span className="underline">
                <a href="mailto:gemsmith101@gmail.com">email</a>
              </span>{' '}
              instead.
            </div>
        ...
        {/* Contact Form */}
        <form action="https://formspree.io/f/mzbowbvk" method="POST">
          {/* Full Name */}
          <div className="">
            <label className="uppercase text-sm text-gray-600 font-bold" htmlFor="name">
              Full Name
            </label>
            <input
      ...
      {/* <!-- ====== Contact Start ====== --> */}
      {/* <section id="contact" className="ud-contact py-20 md:py-[120px] relative">
        <div
          className="
            absolute
            z-[-1]
