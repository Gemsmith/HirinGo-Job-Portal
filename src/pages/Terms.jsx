...
const Terms = () => {
  return (
    <div className="p-4 md:p-8">
      ...
      <div className="px-8 py-10 bg-blue-100 rounded-2xl">
        <p>Welcome to HirinGo!</p>

        <p>
          These terms and conditions outline the rules and regulations for the use of
          HirinGo's Website, located at HirinGo.netlify.app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do
          not continue to use HirinGo if you do not agree to take all of the terms and
        ...
        <p>
          We employ the use of cookies. By accessing HirinGo, you agreed to use cookies in
          agreement with the HirinGo's Privacy Policy.{' '}
        </p>
        ...
        <p>
          Unless otherwise stated, HirinGo and/or its licensors own the intellectual
          property rights for all material on HirinGo. All intellectual property rights
          are reserved. You may access this from HirinGo for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from HirinGo</li>
          <li>Sell, rent or sub-license material from HirinGo</li>
          <li>Reproduce, duplicate or copy material from HirinGo</li>
          <li>Redistribute content from HirinGo</li>
        </ul>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. HirinGo does not
          filter, edit, publish or review Comments prior to their presence on the website.
          Comments do not reflect the views and opinions of HirinGo,its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, HirinGo shall
        ...
        <p>
          HirinGo reserves the right to monitor all Comments and to remove any Comments
        ...
        <p>
          You hereby grant HirinGo a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          of HirinGo; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          HirinGo. Please include your name, your organization name, contact information
        ...
        <p>
          No use of HirinGo's logo or other artwork will be allowed for linking absent a
